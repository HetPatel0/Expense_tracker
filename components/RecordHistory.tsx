...
const RecordHistory = async () => {
    ...
    return (
      <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50'>
        <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-bold bg-linear-to-r from-gray-900 to-gray-600 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent'>
              Expense History
            </h3>
  ...
  if (!records || records.length === 0) {
    return (
      <div className=' backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl '>
        <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
        ...
        <div className='text-center py-6 sm:py-8'>
          <div className='w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-br from-emerald-100 to-green-100 dark:from-emerald-900/50 dark:to-green-900/50 rounded-2xl flex items-center justify-center mx-auto mb-4'>
